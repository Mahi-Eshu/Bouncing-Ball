...
canvas.style.borderLeft = "5px solid rgb(143, 143, 143)";
canvas.style.borderRight = "5px solid rgb(143, 143, 143)";
...
const bounceBall = {
  ...
  debugger;
    if (
      this.position.x + this.radius > CW || this.position.x - this.radius < 0) {
       this.angle = 180 - this.angle;
      this.color = "red";
   
    }
    if (
      this.position.y + this.radius > CH || this.position.y - this.radius < 0) {
